              ...
              if (preg_match("!image!",$_FILES['avatar']['type'])) 
              {
                  if (copy($_FILES['avatar']['tmp_name'], $avatar_path)) 
                  {
                    ...
                    $_SESSION[ 'message' ]="avatar ";
                      ...
                      $sql = "INSERT INTO admin (admin_id,name,user_name,email, password,gender,date_of_birth,image,address,user_type)"
                               . "VALUES (Null,'$name', '$username', '$email','$password','$gender','$date','$avatar_path','$address','$admint')";

                    $sql2 = "INSERT INTO login(username,password,user_type)"."VALUES ('$username','$password','$admint')";
...
<div class="body-content">
  <div class="module">
    <h1>NEW ADMIN REGISTRATION PAGE</h1>
