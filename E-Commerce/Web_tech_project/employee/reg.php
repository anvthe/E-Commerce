            ...
            if ($name_error == '' and $email_error == '' and $password_error==''and $gender_error=='' and $date=='')
            {
              ...
              {     
                  if (copy($_FILES['avatar']['tmp_name'], $avatar_path)) 
                  {
                      ...
                      $sql = "INSERT INTO user (customer_id,name,email,user_name, password,gender,date_of_birth,image,address,user_type)"
                               . "VALUES (Null,'$name', '$email','$username', '$password','$gender','$date','$avatar_path','$address','$usert')";
